...
class TestStormUiServer(TestStormBase):
  ...
  def test_start_default(self):
    ...
    self.assertResourceCalled('Execute', 'ambari-sudo.sh ln -s /opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink-legacy-with-common-*.jar '
                                         '/opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink.jar',
                              not_if=format("ls /opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink.jar"),
                              only_if=format("ls /opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink-legacy-with-common-*.jar")
                              )
  ...
  def test_start_with_apache_classes(self):
    ...
    self.assertResourceCalled('Execute', 'ambari-sudo.sh ln -s /opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink-with-common-*.jar '
                                         '/opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink.jar',
                              not_if=format("ls /opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink.jar"),
                              only_if=format("ls /opt/nsn/ngdb/ambari-metrics-storm-sink/lib/ambari-metrics-storm-sink-with-common-*.jar")
                              )
    self.assertResourceCalled('Execute', 'source /etc/storm/conf/storm-env.sh ; export PATH=$JAVA_HOME/bin:$PATH ; storm ui > /var/log/storm/ui.out 2>&1 &\n echo $! > /var/run/storm/ui.pid',
        path = ['/usr/bin'],
        user = 'storm',
