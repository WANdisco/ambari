...
mapreduce_libs_path = "/usr/wdd/current/hadoop-mapreduce-client/share/hadoop/mapreduce/*"
...
if dfs_ha_enabled:
    dfs_service_rpc_address = default(
        format('/configurations/hdfs-site/dfs.namenode.servicerpc-address.{dfs_ha_nameservices}.{namenode_id}'), None)
    dfs_lifeline_rpc_address = default(
        format('/configurations/hdfs-site/dfs.namenode.lifeline.rpc-address.{dfs_ha_nameservices}.{namenode_id}'), None)
else:
